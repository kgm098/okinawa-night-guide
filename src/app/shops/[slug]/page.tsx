      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <section>
          ...
          <dl>
            ...
            <ShopInfoRow label="アクセス" value={typedShop.access}         icon={IconAccess} />
            <ShopInfoRow label="電話"     value={typedShop.phone}          icon={IconPhone} href={typedShop.phone ? `tel:${typedShop.phone}` : undefined} />
          </dl>
        </section>
